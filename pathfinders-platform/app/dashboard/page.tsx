...
import { Star, Users, Award, TrendingUp, MapPin, DollarSign, ArrowRight } from "lucide-react"
...
const careerRecommendations: CareerRecommendation[] = [
  {
    ...
    requiredSkills: ["Interpersonal Skills", "Conflict Resolution", "Organizational Skills"],
    growthProspects: "Excellent growth opportunities with potential for senior leadership roles",
  },
  {
    id: "2",
    ...
    match: 90,
    salaryRange: "INR 3,00,000 - INR 12,00,000 per annum (including commissions)",
    demandLevel:
    ...
    growthProspects: "Strong growth potential with performance-based advancement",
  },
  {
    id: "3",
    ...
    growthProspects: "Good advancement opportunities in corporate communications",
  },
  {
    id: "4",
    ...
    growthProspects: "Stable career path with opportunities in policy development",
  },
]
    ...
    <div className="flex min-h-screen bg-[#f5f3f0]">
      ...
      <main className="flex-1 p-8">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h1 className="text-4xl font-bold text-[#8b4513] mb-4">Welcome to Your Career Dashboard</h1>
            <p className="text-[#d4621a] text-lg">Your personalized career journey starts here</p>
          </motion.div>
          ...
          >
            <Card className="bg-white border-[#e5e1dc] shadow-sm">
              <CardContent className="p-6 text-center">
                <div className="w-12 h-12 bg-[#d4621a] rounded-full flex items-center justify-center mx-auto mb-3">
                  <Star className="w-6 h-6 text-white" />
                </div>
                <div className="text-3xl font-bold text-[#8b4513] mb-1">
                  {stats.quizScore.current}/{stats.quizScore.total}
                </div>
                <div className="text-[#d4621a] font-medium">Quiz Score</div>
                <Progress value={(stats.quizScore.current / stats.quizScore.total) * 100} className="mt-2 h-2" />
              </CardContent>
            </Card>
            ...
            <Card className="bg-white border-[#e5e1dc] shadow-sm">
              <CardContent className="p-6 text-center">
                ...
                <div className="text-3xl font-bold text-[#8b4513] mb-1">{stats.totalPoints}</div>
                <div className="text-[#d4621a] font-medium">Total Points</div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white border-[#e5e1dc] shadow-sm">
              <CardContent className="p-6 text-center">
                ...
                <div className="text-3xl font-bold text-[#8b4513] mb-1">{stats.personalityType}</div>
                <div className="text-[#d4621a] font-medium">Personality Type</div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white border-[#e5e1dc] shadow-sm">
              <CardContent className="p-6 text-center">
                ...
                <div className="text-3xl font-bold text-[#8b4513] mb-1">{stats.badgesEarned}</div>
                <div className="text-[#d4621a] font-medium">Badges Earned</div>
              </CardContent>
            </Card>
          </motion.div>
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h2 className="text-3xl font-bold text-[#8b4513] mb-6">Your Career Recommendations</h2>
                  ...
                  <Card className="bg-white border-[#e5e1dc] hover:shadow-lg transition-all duration-300 h-full">
                    <CardHeader className="pb-4">
                      <div className="flex items-start justify-between mb-3">
                        <CardTitle className="text-xl text-[#8b4513] leading-tight">{career.title}</CardTitle>
                        <Badge className={`${getMatchColor(career.match)} font-semibold`}>{career.match}% Match</Badge>
                      </div>
                    </CardHeader>
                    <CardContent className="pt-0">
                      <p className="text-[#6b5b73] leading-relaxed mb-4 line-clamp-3">{career.description}</p>

                      <div className="space-y-3 mb-4">
                        <div className="flex items-start gap-2">
                          <DollarSign className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
                          <span className="text-sm text-[#6b5b73]">{career.salaryRange}</span>
                        </div>
                        <div className="flex items-start gap-2">
                          <TrendingUp className="w-4 h-4 text-blue-600 mt-0.5 flex-shrink-0" />
                          <span className="text-sm text-[#6b5b73] line-clamp-2">{career.demandLevel}</span>
                        </div>
                      </div>
