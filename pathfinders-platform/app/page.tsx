...
export default function HomePage() {
  return (
    <div className="flex min-h-screen bg-[#edd3b4]">
      <Sidebar />
      <main className="flex-1 relative overflow-hidden flex">
        {/* Left: Main Content - Centered Vertically */}
        <div className="flex-1 flex flex-col justify-center items-start relative z-10 p-8 lg:p-12 min-h-screen">
          {/* Header Badge */}
          <motion.div
        ...
        {/* Right: Image */}
        <div className="hidden lg:flex items-center justify-center h-full w-1/2 relative">
          <img
            src="/hands.jpeg"
            alt="Hands"
