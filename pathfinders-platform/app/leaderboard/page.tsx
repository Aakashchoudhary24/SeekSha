...
export default function LeaderboardPage() {
  ...
  const getRankIcon = (rank: number) => {
    switch (rank) {
      ...
      default:
        return (
          <span className="text-2xl font-bold text-[#8b4513]">#{rank}</span>
        );
    }
  };
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    <Avatar className="w-16 h-16">
                      ...
                      <AvatarFallback className="bg-[#d4621a] text-white text-lg">
                        YU
                      </AvatarFallback>
                    </Avatar>
                    <div>
              ...
              <div className="flex flex-col items-center order-1">
                <Card className="bg-white border-[#e5e1dc] shadow-lg w-full">
                  <CardContent className="p-6 text-center">
                    ...
                    <div className="text-2xl font-bold text-[#d4621a] mb-1">
                      {users[1]?.points}
                    </div>
                    <div className="text-sm text-[#a0826d]">points</div>
                  </CardContent>
              ...
              <div className="flex flex-col items-center order-2">
                <Card className="bg-white border-[#e5e1dc] shadow-xl w-full transform scale-105">
                  <CardContent className="p-6 text-center">
                    ...
                    <h3 className="font-bold text-[#8b4513] mb-1 text-lg">
                      {users[0]?.name}
                    </h3>
                    <Badge
                      className={`${getBadgeColor(
                    ...
                    <div className="text-3xl font-bold text-[#d4621a] mb-1">
                      {users[0]?.points}
                    </div>
                    <div className="text-sm text-[#a0826d]">points</div>
                  </CardContent>
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <Badge
                            className={`${getBadgeColor(user.badge)} text-xs`}
                          >
                            {user.badge}
                          </Badge>
                        </div>
