...
# Optional: google API client for YouTube
...
def find_relevant_wiki_info(query: str) -> Dict[str, Optional[str]]:
    ...
    # Heuristic for syllabus/pattern
...
def fetch_free_pyqs_links(exam_query: str) -> List[Dict]:
    ...
    # Optional: further scraping to list chapters/papers
    scraped_links = []
    for item in links:
        try:
